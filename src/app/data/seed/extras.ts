...
export const projectDetailExtras: Record<string, Partial<ProjectDetailData>> = {
  ...
  "p-hi1": {
    ...
    homeImprovementType: "Window",
    homeImprovementQty: 12,
    panelModel: "N/A",
    panelCount: 0,
    inverterModel: "N/A",
    inverterCount: 0,
  ...
  "p-hi2": {
    financePayment: "$310/Month",
    systemSizeKw: "0kW",
    estOffset: "0%",
    projectType: "Home Improvement",
    homeImprovementType: "HVAC",
    homeImprovementQty: 2,
    panelModel: "N/A",
    panelCount: 0,
    inverterModel: "N/A",
    inverterCount: 0,
  ...
  "p-hi3": {
    financePayment: "$185/Month",
    systemSizeKw: "0kW",
    estOffset: "0%",
    projectType: "Home Improvement",
    homeImprovementType: "Insulation",
    homeImprovementQty: 1,
    panelModel: "N/A",
    panelCount: 0,
    inverterModel: "N/A",
    inverterCount: 0,
  ...
  "p-hi4": {
    financePayment: "$155/Month",
    systemSizeKw: "0kW",
    estOffset: "0%",
    projectType: "Home Improvement",
    homeImprovementType: "Water Heater",
    homeImprovementQty: 1,
    panelModel: "N/A",
    panelCount: 0,
    inverterModel: "N/A",
    ...
    batteryCount: 0,
    addersTotal: 800,
    financingTotal: 6200.0,
    totalLoan: 5000.0,
    term: "5 Years",
    lender: "Dividend Finance",
    netPricePerSquare: 0,
    pricePerSquare: 0,
    estimatedProduction: "N/A",
  },
  "p-roof1": {
    financePayment: "$275/Month",
    systemSizeKw: "0kW",
    estOffset: "0%",
    projectType: "Roofing",
    roofingShingleType: "Timberline HDZ",
    roofingSquares: 32,
    panelModel: "N/A",
    panelCount: 0,
    inverterModel: "N/A",
    ...
    batteryCount: 0,
    addersTotal: 0,
    financingTotal: 22000.0,
    totalLoan: 18500.0,
    term: "15 Years",
    lender: "Goodleap",
    netPricePerSquare: 4.25,
    pricePerSquare: 6.88,
    estimatedProduction: "N/A",
  },
  "p-roof2": {
    financePayment: "$230/Month",
    systemSizeKw: "0kW",
    estOffset: "0%",
    projectType: "Roofing",
    roofingShingleType: "Duration",
    roofingSquares: 28,
    panelModel: "N/A",
    panelCount: 0,
    inverterModel: "N/A",
    ...
    batteryCount: 0,
    addersTotal: 1500,
    financingTotal: 19200.0,
    totalLoan: 16000.0,
    term: "15 Years",
    lender: "Mosaic",
    netPricePerSquare: 3.80,
    pricePerSquare: 6.86,
    estimatedProduction: "N/A",
  },
  "p-roof3": {
    financePayment: "$385/Month",
    systemSizeKw: "0kW",
    estOffset: "0%",
    projectType: "Roofing",
    roofingShingleType: "Landmark Pro",
    roofingSquares: 45,
    panelModel: "N/A",
    panelCount: 0,
    inverterModel: "N/A",
    ...
    batteryCount: 0,
    addersTotal: 2200,
    financingTotal: 34500.0,
    totalLoan: 30000.0,
    term: "20 Years",
    lender: "Goodleap",
    netPricePerSquare: 4.50,
    pricePerSquare: 7.67,
    estimatedProduction: "N/A",
  },
};
